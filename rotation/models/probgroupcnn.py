...
class ProbConvNormNonlin(torch.nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
        ...
        # Conv layer
        self.conv = partial_gconv.LocalGroupConv(
...
class ProbGCNN(torch.nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
        ...
        **kwargs,
        ...
        # Lifting
        LiftingConv = partial_gconv.PartialLiftingConv
