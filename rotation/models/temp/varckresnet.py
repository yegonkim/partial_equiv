...
from .ckresnet import CKResBlock


class VarCKResBlock(torch.nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
...
class VarCKResNet(torch.nn.Module):
    def __init__(
        self,
        in_channels: int,
        out_channels: int,
        ...
        **kwargs,
        ...
        # Lifting
        self.lift_conv = partial_gconv.VarLiftingConv(
            in_channels=in_channels,
        ...
        self.last_gconv = partial_gconv.VarGroupConv(
